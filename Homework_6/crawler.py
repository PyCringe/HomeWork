...
class AsyncCrawler:
    ...
    async def _do_fetch(self, url: str, domain: str, crawl_delay: float | None, attempt_timeout: float) -> str:
    ...
    async def fetch_url(self, url: str) -> str:
        ...
        try:
            text = await self.retry_strategy.execute_with_retry(_attempt)
